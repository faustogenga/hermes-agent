...
const PROVIDER_GROUPS: { prefix: string; name: string; priority: number }[] = [
  ...
  { prefix: "GITHUB_",          name: "GitHub",            priority: 5 },
  { prefix: "GH_",              name: "GitHub",            priority: 5 },
  { prefix: "COPILOT_",         name: "GitHub",            priority: 5 },
  { prefix: "HF_",              name: "Hugging Face",      priority: 6 },
  { prefix: "HUNTER_",          name: "Hunter",            priority: 7 },
  { prefix: "GLM_",             name: "GLM / Z.AI",        priority: 8 },
  { prefix: "ZAI_",             name: "GLM / Z.AI",        priority: 8 },
  { prefix: "Z_AI_",            name: "GLM / Z.AI",        priority: 8 },
  { prefix: "KIMI_",            name: "Kimi / Moonshot",   priority: 9 },
  { prefix: "MINIMAX_",         name: "MiniMax",           priority: 10 },
  { prefix: "MINIMAX_CN_",      name: "MiniMax (China)",   priority: 11 },
  { prefix: "APOLLO_",          name: "Apollo",            priority: 12 },
