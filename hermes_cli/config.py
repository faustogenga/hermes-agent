...
OPTIONAL_ENV_VARS = {
    ...
    "HUNTER_API_KEY": {
        "description": "Hunter API key for email discovery and company enrichment",
        "prompt": "Hunter API key",
    ...
    "APOLLO_API_KEY": {
        "description": "Apollo API key for B2B contact and company search",
    ...
    "AIRTABLE_WORKSPACE_ID": {
        "description": "Airtable workspace ID for creating the lead-hunter base",
        "prompt": "Airtable workspace ID",
    ...
    "AIRTABLE_BASE_ID": {
        "description": "Airtable base ID used as the main external lead database",
    ...
    "AIRTABLE_LEADS_TABLE": {
        "description": "Airtable table name for verified leads",
        "prompt": "Airtable leads table name",
        "url": "https://airtable.com/developers/web/api/create-base",
        "password": False,
        "category": "tool",
        "advanced": True,
    ...
    "AIRTABLE_RUNS_TABLE": {
        "description": "Airtable table name for run summaries",
        "prompt": "Airtable runs table name",
        "url": "https://airtable.com/developers/web/api/create-base",
        "password": False,
        "category": "tool",
        "advanced": True,
    ...
    "GOOGLE_MAPS_API_KEY": {
        "description": "Google Maps / Places API key for official place corroboration",
        "prompt": "Google Maps / Places API key",
        "url": "https://console.cloud.google.com/google/maps-apis/credentials",
        "password": True,
        "category": "tool",
        "tools": ["web_extract", "browser_navigate"],
        "advanced": True,
    },
    "GOOGLE_PLACES_API_KEY": {
        "description": "Google Places API key (alias for Google Maps / Places usage)",
        "prompt": "Google Places API key",
        "url": "https://console.cloud.google.com/google/maps-apis/credentials",
        "password": True,
        "category": "tool",
        "tools": ["web_extract", "browser_navigate"],
    ...
    "GITHUB_TOKEN": {
        "description": "GitHub token for dashboard GitHub connection, git push/pull, repo automation, and higher API rate limits",
        "prompt": "GitHub Token",
    ...
    "GH_TOKEN": {
        "description": "Alternate GitHub token env var recognized by gh CLI and Hermes GitHub integrations",
        "prompt": "GitHub Token (GH_TOKEN)",
        "url": "https://github.com/settings/personal-access-tokens/new",
        "password": True,
        "category": "tool",
    },
    "COPILOT_GITHUB_TOKEN": {
        "description": "GitHub token used specifically for GitHub Copilot / GitHub Models access",
        "prompt": "GitHub Copilot Token",
        "url": "https://github.com/settings/personal-access-tokens/new",
        "password": True,
        "category": "tool",
    },
